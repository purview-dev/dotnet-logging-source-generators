...
sealed class MSLoggerMessageService : ServiceBase
{
	public void Execute()
	{
	...
	ILogger<MSLoggerMessageService> Logger => ServiceProvider.GetRequiredService<ILogger<MSLoggerMessageService>>();
}
